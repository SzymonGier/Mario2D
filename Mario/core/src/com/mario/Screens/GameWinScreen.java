...
public class GameWinScreen implements Screen {
    ...
    public GameWinScreen(Game game, Label TIME, Label SCORE){
        ...
        Label.LabelStyle fontGreen = new Label.LabelStyle(new BitmapFont(), Color.GREEN);
        ...
        Label gameOverLabel = new Label("VICTORY", fontGreen);
        ...
        Label playAgainLabel = new Label("Click to play again!", fontGreen);
    ...
    public void render(float delta) {
        ...
        if(Gdx.input.justTouched()){
            game.setScreen(new PlayScreen((MarioBros) game,"mapa1.tmx","small","300","0",0.2f,0.2f));
            dispose();
        }
